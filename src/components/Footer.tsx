...
const SOCIAL_LINKS = [
  ...
  {
    name: 'Email',
    url: 'mailto:contact@xrcraftmc.com',
    icon: (
      <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="md:pr-6">
              ...
              <div className="flex items-center gap-2 bg-black/20 p-3 rounded-md pixel-border">
                ...
                <button
                  onClick={handleCopy}
                  className={clsx(
                    'relative glass-btn px-3 py-2 rounded-lg cursor-pointer transition-all duration-200',
                ...
                >
                  <span className="flex items-center gap-2">
                    <svg className="w-4 h-4 text-blue-300" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><rect x="9" y="9" width="13" height="13" rx="2"/><path d="M5 15V5a2 2 0 0 1 2-2h10"/></svg>
